...
<body
	...
	<div style="position: absolute; top: 58px;left: 550px;font-size: 30px;">
		<font color="red" size="15px">${loginError }</font>
	</div>
	<div class="loginbody">

		<span class="systemlogo"></span>
		<div class="loginbox" style="position: relative;top: 0px">
			<form action="${pageContext.request.contextPath}/suspectManage/relogin"
				method="post">
				<ul>
